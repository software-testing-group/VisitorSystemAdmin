<%@ page language="java" contentType="text/html; charset=UTF-8"
  ...
  <div class="sidebar-wrapper" id="accordion">
    ...
    <div id="collapseThree" class="panel-collapse collapse in secondary">
      ...
      <%--</div>--%>
      <div class="dropdown-item-wrapper">
        <a href="${pageContext.request.contextPath}/scenery/infrastructureRoute" class="dropdown-item">基础设施管理</a>
      </div>
      <div class="dropdown-item-wrapper">
        <a href="${pageContext.request.contextPath}/scenery/questionRoute" class="dropdown-item">帮助问题与意见反馈</a>
      </div>
      <%--<div class="dropdown-item-wrapper">--%>
